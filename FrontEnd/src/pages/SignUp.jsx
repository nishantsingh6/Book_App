  ...
  return (
    ...
    >
      <form
        ...
        style={{
          backdropFilter: 'blur(8px)', // Adding a slight blur effect to the form background
        }}
      >
        ...
        <div className="mb-6 flex space-x-4">
          ...
          <div className="flex-1">
            ...
            />
            {errors.firstName && (
              <p className="text-red-500 text-sm mt-1 text-left">{errors.firstName.message}</p>
            )}
          </div>
          ...
          <div className="flex-1">
            ...
            />
            {errors.lastName && (
              <p className="text-red-500 text-sm mt-1 text-left">{errors.lastName.message}</p>
            )}
          </div>
        </div>
        ...
        <p className="flex justify-center text-sm font-medium">
          ...
          <button onClick={() => { navigate("/book/login") }} className="text-blue-500 cursor-pointer">
            Login
          </button>
        </p>
      </form>
